...
namespace HealthInstitution.Commands
{
    public class LogInCommand : BaseCommand
    {
        ...
        {
            Patient userPatient = MVVM.Models.User.FindUser(_institution.GetPatientRepository().GetPatients(), email, password);
            ...
            Doctor userDoctor = MVVM.Models.User.FindUser(_institution.GetDoctorRepository().GetDoctors(), email, password);
            ...
            Secretary userSecretary = MVVM.Models.User.FindUser(_institution.GetSecretaryRepository().GetSecretaries(), email, password);
            ...
            Admin
                userAdmin = MVVM.Models.User.FindUser(_institution.GetAdminRepository().GetAdministrators(), email, password);
